...
const Unknown = ({navigation}) =>{
    ...
    let imageHeight1 = Math.round((dimension.width * 9) / 20);
    let imageWidth1 = dimension.width;
...
{/* body  */}
 ...
 {/* 2rd button */}
               <TouchableOpacity style={{padding:10,backgroundColor:'#DCDCDC',opacity:0.7}}
                 onPress={()=>{navigation.navigate("SoundAlbum")}} 
                >
                    <ImageBackground 
                    ...
                    source={require("../../../../assests/music/album1.png",)}>
                        ...
                        <TouchableOpacity 
                        style={{padding:10,backgroundColor:'#DCDCDC',opacity:0.7}}
                           onPress={()=>{navigation.navigate("WhatsappAlbum")}}
                        >
                            <ImageBackground 
